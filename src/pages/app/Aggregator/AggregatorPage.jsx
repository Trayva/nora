  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              ...
              <span
                style={{
                  ...
                  padding: "2px 8px",
                  borderRadius: 999,
                  background: cart.isLocked
                    ? "rgba(239,68,68,0.08)"
                    : "rgba(34,197,94,0.08)",
                  color: cart.isLocked ? "#ef4444" : "#16a34a",
                  border: `1px solid ${cart.isLocked ? "rgba(239,68,68,0.2)" : "rgba(34,197,94,0.2)"}`,
                }}
              >
                {cart.isLocked ? (
                  <MdLock size={11} />
              ...
              {cart.serviceRadius > 0 && (
                ...
                >
                  <MdSignalCellularAlt size={11} />
                  {cart.serviceRadius} km radius
                </span>
              )}
            </div>
          </div>
          ...
          {[
            {
              label: "Owner",
              value:
                cart.owner?.name || cart.owner?.email || cart.owner?.fullName,
            },
            { label: "Serial", value: cart.serialNumber },
            { label: "Created", value: fmtDate(cart.createdAt) },
            {
              label: "Menu Items",
              value:
                cart.menuItems?.length > 0
                  ? `${cart.menuItems.length} items`
                  : null,
            },
            {
              label: "Operators",
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            {cart.location.latitude && cart.location.longitude && (
              ...
              >
                {Number(cart.location.latitude).toFixed(5)},{" "}
                {Number(cart.location.longitude).toFixed(5)}
              </div>
            )}
          </div>
        </div>
      ...
      {cart.vendor && (
        ...
        >
          {cart.vendor.brandLogo ? (
            <img
              src={cart.vendor.brandLogo}
              alt=""
              style={{
                width: 40,
                height: 40,
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      {name}
                      {op.isApproved && (
                        <MdVerified size={13} style={{ color: "#16a34a" }} />
                      )}
                    </div>
                    {op.user?.email && (
                      <div
    ...
    <div className="page_wrapper">
      ...
      {notFound && (
        ...
        >
          <LuShoppingCart
            size={28}
            style={{ color: "#ef4444", opacity: 0.5, marginBottom: 8 }}
          />
          <div
            style={{
              fontSize: "0.9rem",
          ...
          <div style={{ fontSize: "0.78rem", color: "var(--text-muted)" }}>
            No iCart matched serial number{" "}
            <strong style={{ fontFamily: "monospace" }}>"{serial}"</strong>
          </div>
        </div>
      )}
      ...
      {!cart && !notFound && !searching && (
        ...
        >
          ...
          >
            Search for any iCart by its serial number to view details, tasks,
